...
FollowPath2::FollowPath2(std::vector<std::tuple<frc::Pose2d, double, double, double>> points, bool resetPose, bool persist) : m_points{points}, m_resetPose{resetPose}, m_persist{persist} {}
